    ...
    return (
        <div className="h-full flex flex-col">
            <div className="flex justify-between items-center mb-4">
                <h3 className="font-semibold text-base text-muted-foreground uppercase tracking-wider">Pending Actions</h3>
            </div>
                    ...
                    <div key={action.id} className="border rounded-lg p-3 bg-orange-50/40 border-orange-100 hover:bg-orange-50/80 transition-colors">
                        <div className="flex items-center justify-between mb-2">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="font-medium text-base text-orange-900">Draft Application</span>
                            </div>
                        ...
                        <p className="text-sm text-orange-800/70 mb-3 ml-6 line-clamp-2">
                            Created: {format(new Date(action.created_at), 'MMM d')}
                        </p>
